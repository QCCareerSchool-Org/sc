...
const changesPresent = (unitTemplate: NewUnitTemplate | undefined, formData: State['form']['data']): boolean => {
  if (!unitTemplate) {
    return false;
  }
...
export const NewUnitTemplateEdit: FC<Props> = ({ administratorId, unitId }) => {
