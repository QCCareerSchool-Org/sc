  ...
  event: [
    {
      ...
      courses: [
        ...
        },
        {
          ...
          certification: 'International XXXXXXXXXXXXXXXXXXX',
    ...
    },
    {
      ...
      courses: [
        ...
        },
        {
          ...
          description: 'This course will walk you through the best business practices to grow your existing event planning business. With guidance from your expert tutor, you\'ll build customer personals, improve your online presence, develop marketing materials, and more! You\'ll graduate with an elevated business strategy to help you surpass the competition.',
        },
      ],
    },
  ],
