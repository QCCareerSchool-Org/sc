...
export const NewSubmissionStatus: FC<Props> = memo(({ studentId, courseId, newSubmission, progressStepSize = 5, onProgress }) => {
  ...
  if (newSubmission.closed) {
    ...
    return (
      <div className="alert alert-success">
        ...
        <p>Your assignments have been marked. Please listen to your tutor's audio feedback below.</p>
  ...
  if (newSubmission.submitted) {
    if (newSubmission.skipped) {
      return (
        <div className="alert alert-info">
          ...
          <p className="mb-0">These assignments has been skipped. You won't receive a grade for them.</p>
        </div>
      );
    }
    ...
    return (
      <div className="alert alert-success">
        ...
        <p>Your assignments have been submitted to your tutor. Please check back in a few days to review your tutor's audio feedback.</p>
        <p className="mb-0">In the meantime, you're welcome to <strong>read ahead in your next unit</strong>. Your next assignments will become available once you've passed this unit.</p>
      </div>
    );
  }
  ...
  return (
    <div className="alert alert-info">
      ...
      <p className="mb-0">Your assignments are currently in progress. Once you have completed your assignments, please submit them to your tutor using the &ldquo;Submit Assignments&rdquo; button below.</p>
    </div>
  );
});
