      ...
      <Section>
        <div className="container">
          ...
          <div className="alert alert-primary mb-3">
            <strong><Link href="https://shop.qccareerschool.com" className="alert-link">Shop the QC Career School Store!</Link></strong> Browse our curated selection of companion textbooks and professional tools designed to complement your online course.
          </div>
