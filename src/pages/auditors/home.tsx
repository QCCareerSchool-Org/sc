        ...
        {state.auditor
          ? (
            <>
              ...
              <a href="https://enroll.qcpetstudies.com/earthwise-accelerated-grooming" className="btn btn-primary btn-lg" target="_blank" rel="noreferrer">Enroll New Students</a>
            </>
          )
          : <Spinner />
        }
